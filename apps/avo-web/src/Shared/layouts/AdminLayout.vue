...
const navigation = [
  { name: 'Dashboard', path: '/admin/dashboard', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>' },
  { name: 'Users', path: '/admin/users', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>' },
  { name: 'Platform Settings', path: '/admin/settings', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>' },
  { name: 'Activity Logs', path: '/admin/logs', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>' },
]
  ...
  <div class="min-h-screen bg-slate-50 dark:bg-[#0B1120] flex transition-colors duration-300">
    ...
    <aside class="w-64 bg-slate-900/95 dark:bg-[#0B1120] backdrop-blur-xl flex-shrink-0 flex flex-col hidden md:flex border-r border-slate-200/10 shadow-2xl relative z-20">
      <div class="h-16 flex items-center px-6 bg-slate-900/50 border-b border-white/5 relative overflow-hidden">
        ...
        <span class="ml-3 text-xl font-bold text-white tracking-wide relative z-10">AVO Admin</span>
      </div>
      
      <div class="p-4 flex-1">
        <div class="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-4 px-3">Core Management</div>
        ...
        <div class="flex items-center gap-5">
          ...
          <div class="flex items-center gap-3 pl-5 border-l border-slate-200 dark:border-slate-800">
            <div class="flex flex-col text-right">
              <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ authStore.user?.name || 'Admin' }}</span>
              <span class="text-[10px] uppercase tracking-wider text-blue-600 dark:text-blue-400 font-bold">SUPER_ADMIN</span>
            </div>
            <div class="h-10 w-10 rounded-xl bg-slate-200 dark:bg-slate-800 overflow-hidden border border-slate-300 dark:border-slate-700 shadow-sm">
              <img src="https://ui-avatars.com/api/?name=Admin&background=random" alt="Avatar" class="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </header>
